			...
			<div role="main" class="col-md-10 ml-sm-auto col-lg-10">
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
								...
								<button type="button" class="dropdown-item" data-toggle="modal"
									data-target="#exampleModal" data-whatever="@mdo">가맹점으로</button>
							</div>
				...
				<div id="context">
					...
					<fieldset class="fieldset">
						<legend class="legend">매장 상품</legend>
						...
						<c:forEach items="${products}" var="product">
									...
									<div class="all">
										<table border="1" class="tab">
											<tr id="${product.prodNo}" onclick="selectProd(this.id);">
												<th colspan="2" class="img-form"><img
													src="<c:url value="/upload/${product.prodImgPath}"/>"
													class="img">
													<div class="name">${product.prodName}</div></th>
											</tr>
										</table>
									</div>
								</c:if>
						...
						<button type="button" class="btn btn-info cartBtn"
							onclick="selectedProd();">장바구니</button>
					</fieldset>
				</div>
			</div>
		</div>
