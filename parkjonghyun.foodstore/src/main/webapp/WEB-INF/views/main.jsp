		...
		<div class="row">
			...
			<div role="main" class="col-md-10 ml-sm-auto col-lg-10">
				...
				<div id="context">
					...
					<div id="carouselExampleIndicators" class="carousel slide"
						...
						<div class="carousel-inner" id="carousel-set">
							<div class="carousel-item active">
								<img src="upload/1.jpg" class="d-block w-100" alt="...">
							</div>
							<div class="carousel-item">
								<img src="upload/2.jpg" class="d-block w-100" alt="...">
							</div>
							<div class="carousel-item">
								<img src="upload/3.jpg" class="d-block w-100" alt="...">
							</div>
						</div>
					...
					<div class="imgdiv">
						<div class="img3">
							<a><img src="upload/4.jpg" class="img3a"></a>
				
							<a><img src="upload/5.jpg" class="img3b"></a>
				
							<a><img src="upload/6.jpg" class="img3c"></a>
						</div>
						<div class="img2">
							
							<p><img src="upload/7.jpg" class="img2a"></p>

							<p><img src="upload/8.jpg" class="img2b"></p>
						</div>
					</div>
				</div>
